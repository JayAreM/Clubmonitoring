    ...
    <div class="scrollbar-inner">
        ...
        <div class="sidenav-header  align-items-center">
            <a class="navbar-brand" href="javascript:void(0)">
                <h2 class="text-white">Club Monitoring</h2>
            </a>
        </div>
        <hr class="my-1">
        <div class="navbar-inner">
            ...
            <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                ...
                <ul class="navbar-nav">
                    ...
                    <!-- Add Courses -->
                    <li class="nav-item">
                        <a class="nav-link {{ (request()->is('manage/course*')) ? 'active' : '' }}" href="{{ route('course.index') }}">
               ...
               <!--    <li class="nav-item">
                            <a class="nav-link {{ (request()->is('manage/bylaws*')) ? 'active' : '' }}" href="{{ asset('pdfs/HCDC-Computer-Engineering-Act-of-2019-CpE-Act-1001UPDATED-A.Y.-2022-2023-1.pdf') }}" target="_blank">
                            <i class="fas fa-file-alt text-primary"></i>
                            <span class="nav-link-text">Bylaws</span>
                            </a>
                        </li>
                -->

                    <li class="nav-item">
                            <a class="nav-link {{ (request()->is('manage/bylaws*')) ? 'active' : '' }}" href="{{ route('bylaws.index') }}">
                            <i class="fas fa-file-alt text-primary"></i>
                            <span class="nav-link-text">Bylaws</span>
                            </a>
                         </li> 
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ (request()->is('manage/calendar*')) ? 'active' : '' }}" href="{{ route('calendar.index') }}">
